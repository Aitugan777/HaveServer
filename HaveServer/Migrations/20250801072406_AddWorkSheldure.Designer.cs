...
namespace AitukServer.Migrations
{
    ...
    [Migration("20250801072406_AddWorkSheldure")]
    partial class AddWorkSheldure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AitukServer.Models.AContactType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AitukServer.Models.AShopContact", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AitukServer.Models.AWorkSheldure", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AitukServer.Models.AShopContact", b =>
                {
                    b.HasOne("AitukServer.Models.AShop", null)
                        .WithMany("Contacts")
                        .HasForeignKey("AShopId");
                });
            ...
            modelBuilder.Entity("AitukServer.Models.AWorkSheldure", b =>
                {
                    b.HasOne("AitukServer.Models.AShop", "Shop")
                        .WithOne("WorkSheldure")
                        .HasForeignKey("AitukServer.Models.AWorkSheldure", "ShopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("AitukServer.Models.AWorkDay", "Friday", b1 =>
                        {
                            b1.Property<long>("AWorkSheldureId")
                                .HasColumnType("bigint");
                            ...
                            b1.HasKey("AWorkSheldureId");

                            b1.ToTable("WorkSheldures");

                            b1.WithOwner()
                                .HasForeignKey("AWorkSheldureId");
                        });

                    b.OwnsOne("AitukServer.Models.AWorkDay", "Monday", b1 =>
                        {
                            b1.Property<long>("AWorkSheldureId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("AitukServer.Models.AWorkDay", "Saturday", b1 =>
                        {
                            b1.Property<long>("AWorkSheldureId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("AitukServer.Models.AWorkDay", "Sunday", b1 =>
                        {
                            b1.Property<long>("AWorkSheldureId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("AitukServer.Models.AWorkDay", "Thursday", b1 =>
                        {
                            b1.Property<long>("AWorkSheldureId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("AitukServer.Models.AWorkDay", "Tuesday", b1 =>
                        {
                            b1.Property<long>("AWorkSheldureId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("AitukServer.Models.AWorkDay", "Wednesday", b1 =>
                        {
                            b1.Property<long>("AWorkSheldureId")
                                .HasColumnType("bigint");
